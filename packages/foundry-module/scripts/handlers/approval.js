      ...
      if (report.status === "unknown") {
        throw createBridgeError(
          ...
          `The GM client holding this bridge has no approval state for approvalId ${approvalId}. Approval ` +
            "state is runtime state: it does not survive a reload of that client or a rebuild of its bridge " +
            "connection, and a retained outcome expires. The outcome is therefore indeterminate — the " +
